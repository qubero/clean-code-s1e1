...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='todo-list__item task';
    ...
    checkBox.className="task__checker";
    editInput.type="text";
    ...
    deleteButton.className="task__button-delete button button--delete";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task--edited");
    //If class of the parent is .task--edited
    if(containsClass){

        //switch to .task--edited
    ...
    //toggle .task--edited on the parent.
    listItem.classList.toggle("task--edited");
};
